...
class NecIr:
    def __init__(self, timer=2, channel=4, pin = 1):
        self._t = Timer(timer, prescaler=83, period=0x0fffffff)
        self._ic_pin = pin
        self._ic = self._t.channel(channel, Timer.IC, pin=self._ic_pin, polarity=pyb.Timer.BOTH)
        self._ic_start = 0
        self._ic_width = 0
