...
#testbox_config = RadioConfig(spi_no = 0, csn_pin = 'X5', ce_pin = 'Y11') # My testbox
#v1_config = RadioConfig(spi_no = 1, csn_pin = 8, ce_pin = 9)   # V1 Micropower PCB
v1_config = RadioConfig(spi_no = 1, csn_pin = 15, ce_pin = 14)   # V1 Micropower PCB
#v2_config = RadioConfig(spi_no = 1, csn_pin = 'X5', ce_pin = 'X2')    # V2 Micropower PCB with SD card
master_config = v1_config
slave_config = v1_config
