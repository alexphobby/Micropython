...
steering_map = MAP(54,12,880+servo_trim,1350+servo_trim) #54..12
    ...
    while True:
        ...
        if nrf.any():
            ...
            while nrf.any():
                ...
                setServoNs(steering_out)
                #drive(throttle_val*100)
                ...
                #oled.show()
                #print(f"{str(throttle_val)} - {str(steering_val)}")
                #throttle_out = throttle_map.map_value(throttle_val)
                #print(throttle_out)
                #print(f"map:{throttle_map.map_value(throttle_val)}, {steering_map.map_value(steering_val)}")
                #time.sleep(0.3)
